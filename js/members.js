...
<<<<<<< HEAD
        ...
        // needs a Firestore composite index. A message still mid-flight
        // (createdAt not yet resolved by the server) sorts to the bottom,
        // since it really is the newest one.
